...
#### input ####
###############
rms_val = 1e-2 #2.3e-2  #rms from casa viewer 
sigma = 2.5   
infile = 'HZ7_COMB_CUBE_30_JvM_cut_centered.fits'
emissionChannels = '13~25'#'51~75'   #channels from casa viewer
